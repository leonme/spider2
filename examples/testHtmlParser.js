...
//var rawHtml = '<p  style="color: #0000ff",src="sdfaee">现如今SOA微服务风愈演愈烈，越来越多的业务和资源被以服务的形式包装和发布，服务间又可能会依赖其他各种服务。由此而来不可避免的会产生很多问题。</p><p>比如一个服务，其依赖了另外30个服务。假设每个服务的可用率都有三个9（99.9%），那么我们计算一下：</p><blockquote><p>99.99%^30 = 99.7%</p></blockquote>';
...
//		display(node);
		if(node.name == 'p'){
			...
			mdContent += '`';
			isCodeText = true;
			if(node.children && node.children.type == 'text'){
				mdContent + node.children.data + '`\n'
			}
		}
/*
		//判断是否有属性节点
